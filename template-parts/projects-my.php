...
?>
<div id="pwork-my-projects-page" class="layout-wrapper layout-content-navbar">
            ...
            <div class="container-xl flex-grow-1 container-p-y">
                <div class="pwork-page-header d-flex justify-content-between align-items-center flex-wrap w-100 mb-4">
                    <h2 class="col-12 col-sm-5 fw-bold mb-4">
                        <?php echo esc_html__('My Projects', 'pwork'); ?>
                    </h2>
                ...
                <div id="pwork-projects-wrap" class="row pwork-hide-row" data-userid="<?php echo esc_attr($currentuser->ID); ?>">
